	...
	<div id="menu-profile">
		...
		<ul>
			...
			if ($level == "manager") {
				?>
				<li>
					<a <?php if ($module == "dataproduk") {
								echo "class='active'";
							} ?> href="<?php echo BASE_URL . "index.php?page=my_profile&module=dataproduk&action=list"; ?>">Data Produk</a>
				</li>
				<li>
					<a <?php if ($module == "rekapproduk") {
								echo "class='active'";
							} ?> href="<?php echo BASE_URL . "index.php?page=my_profile&module=rekapproduk&action=list"; ?>">Rekap Produk</a>
				</li>
				<li>
					<a <?php if ($module == "user") {
								echo "class='active'";
